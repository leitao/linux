...
void fp_unavailable_tm(struct pt_regs *regs)
{
	...
	/* This loads and recheckpoints all the registers from the checkpoint
	 * area.  They will remain in registers after the checkpoint so we
	 * don't need to reload them after.  If VMX is in use, the VRs now hold
