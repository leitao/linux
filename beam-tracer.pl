...
my $BEAM_COMPILE = '/home/breno/Devel/beam/beam-3.8.2-pre21/bin/beam_compile';
...
my $BEAM_COMPLAINTS = '/home/breno/Devel/beam/BEAM_ERRORS';
...
my @C_CONFIG = ('/home/breno/.beam/compiler_c_config.tcl');
my @CPP_CONFIG = ('/home/breno/.beam/compiler_cpp_config.tcl');
my @JAVA_CONFIG = ();
...
#                    '--edg=-w --no_wrap_diagnostics');

my @BEAM_OPTS = ( '--beam::parms=/home/breno/.beam/myparams.tcl',
                  '--beam::steps=beam_spectre_steps.tcl',
                  '--edg=-w --no_wrap_diagnostics' );
